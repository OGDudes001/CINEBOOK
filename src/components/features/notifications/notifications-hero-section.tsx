    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 flex items-center">
        <div className="max-w-xl space-y-2">
          ...
          {/* Animated Heading with Red Ringing Bell Icon */}
          <div 
          ...
          >
            <BellRing className="w-10 h-10 md:w-12 md:h-12 text-red-600 fill-red-600 shrink-0" />
          ...
          >
            Stay updated with the latest movies, booking updates, <br className="hidden sm:inline" />
